...
const BiographyPage = () =>{ 
    return (
        <Layout pageTitle="Biography">
            <p>
                Noel Hill was born in <Link to="http://en.wikipedia.org/w/index.php?title=Caherea&action=edit&redlink=1">Caherea</Link> in West <Link to="http://en.wikipedia.org/wiki/County_Clare">County Clare</Link>, Ireland, into a big family with 7 siblings. His parents and grandparents were all  <Link to="http://en.wikipedia.org/wiki/Concertina">concertina</Link> players. He was particularly influenced by his uncle, <Link to="http://en.wikipedia.org/w/index.php?title=Padraig_A_Chnoic&action=edit&redlink=1">Padraig A Chnoic</Link>, (Paddy Hill). He lived in a house which was the last house in the area to hold the traditional Irish House dance, where musicians were always welcomed; particularly towards the end of the year when farm work was done. It was at these events that he learned his early tunes, rather than from the radio, books or records. He started playing at 9 and was lucky to have heard endless hours of <Link to="http://en.wikipedia.org/wiki/Willie_Clancy_(musician)">Willie Clancy</Link>, <Link to="http://en.wikipedia.org/wiki/Paddy_Canny">Paddy Canny</Link>, <Link to="http://en.wikipedia.org/w/index.php?title=Peter_O%27Loughlin&action=edit&redlink=1">Peter O’Loughlin</Link>, <Link to="http://en.wikipedia.org/w/index.php?title=Paddy_Murphy&action=edit&redlink=1">Paddy Murphy</Link>, and <Link to="http://en.wikipedia.org/w/index.php?title=Micky_Hanrahan&action=edit&redlink=1">Micky Hanrahan</Link>.
            </p>
            <p>
                Much of the music in his repertoire today comes from the music he learned as a child from these great players. Noel wanted to be a piper, but pipes were not readily available. He played the concertina which had been initially purchased for his older brother.
            </p>
